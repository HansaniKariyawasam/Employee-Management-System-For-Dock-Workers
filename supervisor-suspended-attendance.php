    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Suspended Attendance Details</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="supervisor-home.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Suspended Attendance Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<!--                            <button id="btnSearch1"  type="submit" name="search" class="btn btn-info" style="margin-left: 20px">Search</button>-->
                    ...
                    <div class="table-responsive" >
                        <table class="table" id="tblSuspendAttendace-sup">
...
<!--                                <th scope="col">Action</th>-->
                        ...
                        <script>
                            $(function () {
                                ...
                                httpRqst.onreadystatechange=function () {
                                    ...
                                    if(httpRqst.readyState === 4 && httpRqst.status===200){
                                        ...
                                        for(var data in jsonString) {
                                            $('#tblSuspendAttendace-sup tbody').append('<tr>' +
                                                ...
                                                // '<td>' +
                                                // '<a id="editEmployee" style="cursor: pointer;color: darkblue;font-size: 20px" data-toggle="tooltip" title="Edit" href="supervisor-edit-suspended-attendance.php?empID='+jsonString[data]['Emp_ID']+'&empDate='+jsonString[data]['Date']+'">\n' +
                                ...
                                httpRqst.open('GET','backend-php/view-suspend-attendance.php',true);
                        ...
                        <script>
                            ...
                            $('#btnSearch2').click(function() {
                                $.ajax({
                                    url: "/myProjects/Payroll Management System/backend-php/search-suspend-attendance.php?id=" + $('#id').val() + "&name=" + $('#name').val() + "&from=" + $('#dateFrom').val() + "&to=" + $('#dateTo').val(),
                                    type: "get",
                                    beforeSend: function() {
                                        $('#tblSuspendAttendace-sup tbody').empty();
                                    },
                                    success: function(result) {
                                        if(result.length===0){
                                            ...
                                            for (var i = 0; i < result.length; i++) {
                                                ...
                                                $('#tblSuspendAttendace-sup').append(row);
                                            }
                                        }

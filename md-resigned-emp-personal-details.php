    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Resigned Employee Personal Details</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="tblEmpPersonal-md" class="table table-striped table-bordered">
                                <thead>
                                <tr>
                                    <th>Employee ID</th>
                                    <th>Name</th>
                            ...
                            <script>
                                $(function () {
                                    ...
                                    httpRqst.onreadystatechange=function () {
                                        ...
                                        if(httpRqst.readyState === 4 && httpRqst.status===200){
                                            ...
                                            for(var data in jsonString) {
                                                $('#tblEmpPersonal-md tbody').append('<tr>' +
                                    ...
                                    httpRqst.open('GET','backend-php/resigned-emp-personal-details.php',true);
                            ...
                            <script>
                                ...
                                $('#btnSearch2').click(function() {
                                    ...
                                    $.ajax({
                                        url: "/myProjects/Payroll Management System/backend-php/search-emp-personal-details.php?status=Resigned&id=" + $('#id').val() + "&name=" + $('#name').val(),
                                        type: "get",
                                        beforeSend: function() {
                                            $('#tblEmpPersonal-md tbody').empty();
                                        },
                                        success: function(result) {
                                            if(result.length===0){
                                                ...
                                                for (var i = 0; i < result.length; i++) {
                                                    var row = $('<tr><td>' + result[i].Emp_ID + '</td><td>' + result[i].Name + '</td><td>' + result[i].Current_status + '</td><td>' + result[i].NIC + '</td><td>' + result[i].Team_Name + '</td><td>' + result[i].Basic_Salary + '</td><td>' + result[i].Permanent_address + '</td><td>' + result[i].Tel_No + '</td><td>' + result[i].Acc_No + '</td><td>' + result[i].Bank_name + '</td><td>' + result[i].Branch_name + '</td></tr>');
                                                    $('#tblEmpPersonal-md').append(row);
                                                }
                                            }

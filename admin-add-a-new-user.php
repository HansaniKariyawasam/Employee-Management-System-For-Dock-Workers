...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form class="form-horizontal m-t-20" action="backend-php/add-new-user.php" method="post">
                        <div class="row p-b-30">
                            <div class="col-10 align-items-center">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input onkeypress="validate()" name="Name" type="text" id="name" class="form-control form-control-lg required" placeholder="Name" aria-label="Name" aria-describedby="basic-addon1" required>
                                </div>
                                <!--Username-->
                                <div class="input-group mb-3">
...
<!--                                </div>-->
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="Designation" id="Designation" class="select2 form-control custom-select"  required>
...
<!--                                    <input onkeypress="validate()" name="Designation" type="text" id="designation" class="form-control form-control-lg" placeholder="Designation" aria-label="Designation" aria-describedby="basic-addon1" required>-->
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" name="Password" id="password" class="form-control form-control-lg" placeholder="Password" aria-label="Password" onchange="validate()" aria-describedby="basic-addon1" required>
                                </div>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" name="confirm_Password" onchange="validate()" id="confirm_password" class="form-control form-control-lg" placeholder=" Confirm Password" aria-label="Password" onchange="validate()" aria-describedby="basic-addon1" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-top col-12">
                            <div class="card-body" style="float:right;">
                                <button type="submit" id="btnAddUser" class="btn btn-primary" style="float:right;">Add a New User</button>
                            </div>
                        </div>
                    </form>
                    <script>

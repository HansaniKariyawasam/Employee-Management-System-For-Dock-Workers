...
<!--                                <button id="btnSearch1"  type="submit" name="search" class="btn btn-info" style="margin-left: 20px">Search</button>-->
                        ...
                        <div class="table-responsive">
                            <table id="tblEmpAttendance-md" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>Employee ID</th>
                                        <th>Name</th>
                                    ...
                                    httpRqst.onreadystatechange=function () {
                                        ...
                                        if(httpRqst.readyState === 4 && httpRqst.status===200){
                                            ...
                                            for(var data in jsonString) {
                                                $('#tblEmpAttendance-md tbody').append('<tr>' +
                            ...
                            <script>
                                ...
                                $('#btnSearch2').click(function() {
                                    $.ajax({
                                        ...
                                        type: "get",
                                        beforeSend: function() {
                                            $('#tblEmpAttendance-md tbody').empty();
                                        },
                                        success: function(result) {
                                            if(result.length===0){
                                                ...
                                                for (var i = 0; i < result.length; i++) {
                                                    ...
                                                    $('#tblEmpAttendance-md').append(row);
                                                }
                                            }

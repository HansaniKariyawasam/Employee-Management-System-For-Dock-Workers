            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Modify a User</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Modify a User</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        httpRqst.onreadystatechange=function () {
                                            ...
                                            if(httpRqst.readyState === 4 && httpRqst.status===200){
                                                ...
                                                for(var data in jsonString) {
                                                    //Pass the Username of the user to backend php file of modify-a-user.php through the query string
                                                    var href="admin-edit-a-user.php?username="+jsonString[data]['Username'];
                                                    ...
                                                    $('#tblRemoveUser tbody').append('<tr>' +
                                                        ...
                                                        '<td>' +
                                                            '<a id="removeEmployee"  style="cursor: pointer;color: darkblue;font-size: 20px" data-toggle="tooltip" title="Edit" href="' + href + '">' +

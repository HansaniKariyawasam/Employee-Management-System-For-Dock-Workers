...
$siteURL = 'https://localhost/myProjects/Pharmacy/';
$PHPMailerAutoloadPath = 'C:\xampp\htdocs\myProjects\Pharmacy\phpmailer\vendor\autoload.php'; //enter the complete filepath to PHPMailer's 'PHPMailerAutoload.php' file if you have already installed PHPMailer. Leave blank if you have downloaded PHPMailer with this library.
...
$fromEmailID = 'sachinda.jayasinghe@gmail.com'; //confirmation email will be sent from this email.
$fromName = 'Pharmacy'; //name that will dispay as the sender of confirmation email.
...
$mailUsername = 'sachinda.jayasinghe@gmail.com'; //usually the email address, but check with Email provider.

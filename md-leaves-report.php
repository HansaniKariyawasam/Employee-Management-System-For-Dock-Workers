    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Leave Days Graph - <input type="text" id="year" disabled style="outline: none;background-color: transparent;border: none;"></h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#hp">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Leave Days</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <script>
                            ...
                            function renderChart(id) {
                                $.ajax({
                                    method: "POST",
                                    url: "backend-php/report-leave-days.php",
                                    data: {val:year,id:id}
                                })

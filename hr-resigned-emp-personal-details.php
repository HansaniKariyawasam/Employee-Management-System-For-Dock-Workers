                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="divSearch" class="form-group row">
                                ...
                                <label class="col-md-1 text-right control-label col-form-label" name="name" id="name">Name</label>
                                <input type="text" class="col-md-3 form-control">

                                <button id="btnSearch2"  type="submit" name="search" class="btn btn-info" style="margin-left: 30px;">Search</button>
                                <hr>

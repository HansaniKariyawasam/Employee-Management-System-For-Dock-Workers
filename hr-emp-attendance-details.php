...
<!--                            <h5 class="card-title">Basic Datatable</h5>-->
                            <div class="table-responsive">
                                <table id="tblEmpAttendance-hr" class="table table-striped table-bordered">
                                    <thead>
                                    <tr>
                                        <th>Employee ID</th>
                                        <th>Name</th>
                                        ...
                                        httpRqst.onreadystatechange=function () {
                                            ...
                                            if(httpRqst.readyState === 4 && httpRqst.status===200){
                                                ...
                                                for(var data in jsonString) {
                                                    $('#tblEmpAttendance-hr tbody').append('<tr>' +
                                ...
                                <script>
                                    ...
                                    $('#btnSearch2').click(function() {
                                        $.ajax({
                                            ...
                                            type: "get",
                                            beforeSend: function() {
                                                $('#tblEmpAttendance-hr tbody').empty();
                                            },
                                            success: function(result) {
                                                if(result.length===0){
                                                    ...
                                                    for (var i = 0; i < result.length; i++) {
                                                        ...
                                                        $('#tblEmpAttendance-hr').append(row);
                                                    }
                                                }

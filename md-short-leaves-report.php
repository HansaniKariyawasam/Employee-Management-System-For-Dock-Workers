    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Short Leave Graph - <input type="text" id="year" disabled style="outline: none;background-color: transparent;border: none;"> </h4>
                    ...
                    <div class="card-body">
                        ...
                        <script>
                            ...
                            function renderChart(id) {
                                $.ajax({
                                    method: "POST",
                                    url: "backend-php/report-short-leaves.php",
                                    data: {val:year,id:id}
                                })

            ...
            <div class="col-12 d-flex no-block align-items-center">
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="managing-director-home.php">Home</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="tblCurrentEmpPersonal-md" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>Employee ID</th>
                                        <th>Name</th>
                            ...
                            <script>
                               ...
                               console.log(jsonString);
                                            for(var data in jsonString) {
                                                $('#tblCurrentEmpPersonal-md tbody').append('<tr>' +
                            ...
                            <script>
                                ...
                                $('#btnSearch2').click(function() {
                                    ...
                                    $.ajax({
                                        ...
                                        type: "get",
                                        beforeSend: function() {
                                            $('#tblCurrentEmpPersonal-md tbody').empty();
                                        },
                                        success: function(result) {
                                            if(result.length===0){
                                                ...
                                                for (var i = 0; i < result.length; i++) {
                                                    ...
                                                    $('#tblCurrentEmpPersonal-md').append(row);
                                                }
                                            }
